      ...
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp">
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/file/d/1XV1pJx1H4ke5SbKl9xpRAZhixu0zeeUH/view?usp=sharing" className="bg-gray-600 p-4 rounded-2xl hover:bg-gray-500">Download CV <i className="ri-download-line ri-lg"></i> </a>
      ...
      <div className="experience-education mt-32 py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div data-aos="fade-left" data-aos-duration="1000" data-aos-delay="400" data-aos-once="true">
            ...
            <div className="space-y-6">
              <div className="p-6 bg-zinc-800 rounded-lg border border-zinc-700">
                <p className="text-sm text-gray-400 mb-1">Sep 2021 – Jul 2025</p>
                ...
                <br></br>
                <a href="https://drive.google.com/file/d/1hg3MQQUxjQIBMWLeIJErxSvBrv5U1AIr/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="bg-gray-600 p-4 rounded-2xl hover:bg-gray-500 inline-block">Check Certificate <i className="ri-download-line ri-lg"></i> </a>
              </div>
              <div className="p-6 bg-zinc-800 rounded-lg border border-zinc-700">
                <p className="text-sm text-gray-400 mb-1">Achieved on 24 September 2022</p>
                <h3 className="text-xl font-bold">English First (EF)</h3>
                <p className="mt-2 text-gray-300">Graduated With Level Intermediate 9</p>
                <ul className="list-disc list-inside mt-2 text-gray-400 text-sm space-y-1">
                  <li>Fluent English</li>
                  <li>Business Communication</li>
                </ul>
                 <br></br>
                <a href="https://drive.google.com/file/d/1zGQLB6h2rfPqdUoh9VyyobCSj7-2Zxxt/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="bg-gray-600 p-4 rounded-2xl hover:bg-gray-500 inline-block">Check Certificate <i className="ri-download-line ri-lg"></i> </a>
              </div>
            </div>
          </div>
        </div>
